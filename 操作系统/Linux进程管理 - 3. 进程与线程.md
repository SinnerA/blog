...
引入进程的目的，是为了多道程序能并发执行，而引入线程，则是**为了减少并发执行时的所付出的开销，提高并发性能**。进程下面的线程共享了进程的某些资源，有自己独立的运行栈。
...
轻量级进程（LWP）在Linux中指的就是clone出来的进程，用它支持了多线程。
...
![LWP.JPG](https://github.com/SinnerA/blog/blob/master/illustrations/LWP.png)
...
![Uthread1.JPG](https://github.com/SinnerA/blog/blob/master/illustrations/Uthread1.png)
